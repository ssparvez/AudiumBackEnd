...
public class LibraryController {
  ...
  @GetMapping(value = "/artists/account/{accountId}")
  public LibraryArtist getArtistByAccountId(@PathVariable long accountId) {
    return libraryService.getArtistByAccountId(accountId);
  }
